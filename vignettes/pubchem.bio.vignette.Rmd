...
1. Bring a metabolomcs-focused subset PubChem onto their local computer
2. Build a metabolomic structure database of all biological compounds in PubChem
3. Define a core biological metabolome, comprising metabolites plausibly found in any species
4. Develop custom metabolomic structure databases using selected or all available taxonomic data in PubChem.
...
__I AM GOING TO BE WORDY HERE, BUT PLEASE READ THIS, AS IT WILL HELP YOU APPLY THE pubchem.bio PACKAGE TO MEET YOUR NEEDS.__
