...
### For your convenience:  All functions, to run the full workflow locally

Just make sure to set the pc.directory to something that makes sense for your system.

```{r all.steps, eval=FALSE}
install.packages(pubchem.bio, dependencies = TRUE)
local.pubchem.directory <- "C:/Temp/20250703"  ## i suggest this naming scheme, but feel free to chose your own.
